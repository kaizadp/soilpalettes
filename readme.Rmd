...
soil_palette(name="eutrostox")
soil_palette(name="natrudoll")
soil_palette(name="paleustalf")
soil_palette(name="podzol")
soil_palette(name="rendoll")
soil_palette(name="vitrixerand")
...
soil_palette(name="pywell")
```

#### others

```{r misc, echo = FALSE}
soil_palette(name="redox")
soil_palette(name="redox2")
soil_palette(name="crait")
soil_palette(name="gley")
...
```{r usage3, fig.height=5, echo=TRUE}
...
```{r usage4, fig.height=5, echo=TRUE}
